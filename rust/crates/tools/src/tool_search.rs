...
use super::ToolSpec;
use crate::agent_helpers::canonical_tool_token;
...
pub(crate) fn execute_tool_search(query: String, max_results: Option<usize>) -> ToolSearchOutput {
    let deferred = deferred_tool_specs();
    let max_results = max_results.unwrap_or(5).max(1);
