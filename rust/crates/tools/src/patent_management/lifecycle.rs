...
",
        ...
        Template {
            id: "invalidity-request",
            name: "无效宣告请求模板",
            description: "专利无效宣告请求书模板",
            required_vars: vec![
                "requester",
                "patent_number",
                "patent_title",
...
",
        ...
        Template {
            id: "patent-search-report",
            name: "专利检索报告模板",
            description: "专利检索分析报告模板",
            required_vars: vec![
                "search_topic",
                "databases",
                "search_strategy",
